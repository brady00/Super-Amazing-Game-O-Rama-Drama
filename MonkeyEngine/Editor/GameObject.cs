...
namespace Editor
{
    ...
    class GameObject
    {
        public unsafe void* EngineGameObject;
        ...
        unsafe public string Name
        {
            get
            {
                ...
                {
                    NameGrabbed = true;
                    _Name = GetFullName(EngineGameObject);
                }
                return _Name;
            }
            set
        ...
        unsafe public uint Flags
        {
            get
            {
                ...
                {
                    FlagsGrabbed = true;
                    _Flags = GetFlags(EngineGameObject);
                }
                return _Flags;
            }
            set
        ...
        unsafe public bool Active
        {
            get
            {
                ...
                {
                    ActiveGrabbed = true;
                    _Active = GetActive(EngineGameObject);
                }
                return _Active;
            }
            set
        ...
        unsafe public bool Static
        {
            get
            {
                ...
                {
                    StaticGrabbed = true;
                    _Static = GetStatic(EngineGameObject);
                }
                return _Static;
            }
            set
        ...
        unsafe public uint Layer
        {
            get
            {
                ...
                {
                    LayerGrabbed = true;
                    _Layer = GetLayer(EngineGameObject);
                }
                return _Layer;
            }
            set
